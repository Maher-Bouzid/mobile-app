...
import { ScrollView, StyleSheet, TouchableOpacity, Image, ImageBackground, Dimensions } from "react-native";
      ...
      <Block flex>
        ...
        <Block style={{ paddingHorizontal: theme.SIZES.BASE }}>
          ...
          <Block row space="evenly">
            ...
            <Block flex center>
              <Button center shadowless color={materialTheme.COLORS.DEFAULT} textStyle={styles.optionsText} style={[styles.optionsButton, styles.shadow]}>
                DELETE
              </Button>
            </Block>
    ...
    return (
      <Block flex style={styles.group}>
        ...
        <Block>
          ...
          <Block style={{ marginBottom: theme.SIZES.BASE }}>
            <Header tabs search title="Title" tabTitleLeft="Option 1" tabTitleRight="Option 2" navigation={this.props.navigation} />
          </Block>
        </Block>
      </Block>
    );
